...
parser.add_argument('input_data', type=str, help='入力情報（"hoge hoho ddd" or " hoge-hoho-ddd"）データ点数＝カラム数とすること')

args = parser.parse_args()
log_save_Fpath = args.log_save_Fpath
col_n = [i for i in args.col_n.split(" ")]
input_data = [k.replace("-"," ") for k in args.input_data.split(" ")]
